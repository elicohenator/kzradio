function player_update_live_show(showObject) {
	...
	function setJPlayerDetails(prefix) {
		document.getElementById('jplayer_title').innerHTML =
			prefix + ': ' + showObject.show + ' / ' + showObject.dj;
		...
		document.getElementById('player_image_div').style.backgroundImage =
			'url(' + showObject.image + ')';
	}
